...
from portal.views.teacher.dashboard import dashboard_manage, organisation_allow_join, organisation_deny_join, organisation_kick, organisation_toggle_admin, teacher_disable_2FA
from portal.views.registration import teacher_password_reset, password_reset_done, student_password_reset, password_reset_check_and_confirm
js_info_dict = {
